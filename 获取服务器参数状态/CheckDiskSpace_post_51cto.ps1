...
# REPORT PROPERTIES
	...
	# Report name
		$reportName = "DiskSpaceRpt_$(get-date -format yyyyMMdd).html";
...
$header = "
		...
		<font face='tahoma' color='#003399' size='4'><strong>Server DiskSpace Report for $titledate</strong></font>
		</td>
		</tr>
		</table>
"
...
# Create and write Table header for report
 ...
 <table width='100%'><tbody>
	...
	<td width='10%' align='center'>Drive Label</td>
...
# Set background color to Orange if space is Critical
 ...
 # Create table data rows 
    $dataRow = "
		...
		<td width='10%' bgcolor=`'$color`' align='center'>$percentFree</td>
		</tr>
"
    ...
    foreach ($user in $users)
{
		...
		$msg.Subject = "Server DiskSpace Report for $titledate"
        $msg.IsBodyHTML = $true
